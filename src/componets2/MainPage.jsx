...
const MainPage = () => {
  ...
  return (
    <div className="MainPage bg-[#edf3f8] w-full">
      {/* First Row */}
      <div className="grid grid-cols-1 sm:grid-cols-10  my-8">
        ...
        <div className="col-span-6 flex flex-col justify-center ">
          ...
          <div className="text-4xl  sm:text-6xl lg:text-7xl font-bold font-poppins">
            <div className="flex items-center">
              <h1>Stylish</h1>
              <div className="bouncer ml-4 xl:ml-8 w-16 h-16 relative overflow-hidden">
                <div
      ...
      {/* Second Row */}
      <div className="grid grid-cols-1 sm:grid-cols-10  gap-y-12 ">
        ...
        <div className="AnimateCarousel col-span-6 pt-6  w-full">
          <div className="flex gap-4 sm:gap-8 overflow-x-auto scrollbar-hide">
            {sneakers.map((shoe, index) => (
              ...
              >
                <div className="relative flex justify-center items-end w-full h-32 xl:h-36 bg-gray-200 rounded-t-lg">
                  ...
                  <img
                    src={shoe.image}
                    alt={shoe.name}
                    className="object-contain w-32 h-32 xl:w-36 xl:h-36"
                  />
        ...
        <div className="flex flex-col gap-y-12">
          ...
          <div className="SizeAnimation col-span-4 flex justify-start h-full ]">
            <div className=" relative w-full sm:max-w-sm h-full flex flex-col">
              <div className=" bg-black pb-2  lg:pb-4  px-6 xl:px-12 rounded-t-xl backdrop-blur-lg shadow-lg text-white w-full sm:w-[calc(40vw)]  flex-grow flex flex-col justify-between">
                ...
                <div className="mt-2 xl:mt-4 flex-grow flex flex-col sm:justify-around lg:justify-center">
                  ...
                  <div className="my-6 h-[0.2px] w-full bg-white/40"></div>
