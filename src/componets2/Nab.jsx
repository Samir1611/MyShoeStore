...
const Nab = () => {
  ...
  return (
    <>
      <nav id="navver">
        {/* Create a 12-column grid, with the first 7 for the logo and links and the last 5 for the icons */}
        <div className="nav-items grid grid-cols-12 items-center sm:gap-4">
          ...
          <div className="logo col-span-2 flex items-center">
            <a className="" style={{ fontSize: "clamp(1.5rem, 1.5vw, 2rem)" }}>
              Sam's&nbsp;store
            </a>
          </div>
          ...
          <div className="nav-links col-span-3 sm:col-span-7 flex justify-center">
            <div className="hidden sm:block">
              <ul className="flex justify-center items-center sm:gap-[2vw] pr-16">
                <li className="font-bold">Man</li>
                <li>Woman</li>
                <li>Kids</li>
                <li>Trending</li>
              </ul>
